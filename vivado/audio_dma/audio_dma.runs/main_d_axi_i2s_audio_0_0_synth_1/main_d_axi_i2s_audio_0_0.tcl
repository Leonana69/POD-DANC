...
OPTRACE "main_d_axi_i2s_audio_0_0_synth_1" START { ROLLUP_AUTO }
...
synth_design -top main_d_axi_i2s_audio_0_0 -part xc7z020clg400-1 -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix main_d_axi_i2s_audio_0_0_ main_d_axi_i2s_audio_0_0.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ main_d_axi_i2s_audio_0_0_stub.v
 lappend ipCachedFiles main_d_axi_i2s_audio_0_0_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ main_d_axi_i2s_audio_0_0_stub.vhdl
 lappend ipCachedFiles main_d_axi_i2s_audio_0_0_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ main_d_axi_i2s_audio_0_0_sim_netlist.v
 lappend ipCachedFiles main_d_axi_i2s_audio_0_0_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ main_d_axi_i2s_audio_0_0_sim_netlist.vhdl
 lappend ipCachedFiles main_d_axi_i2s_audio_0_0_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp main_d_axi_i2s_audio_0_0.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips main_d_axi_i2s_audio_0_0]
 }
...
rename_ref -prefix_all main_d_axi_i2s_audio_0_0_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef main_d_axi_i2s_audio_0_0.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "main_d_axi_i2s_audio_0_0_synth_1_synth_report_utilization_0" "report_utilization -file main_d_axi_i2s_audio_0_0_utilization_synth.rpt -pb main_d_axi_i2s_audio_0_0_utilization_synth.pb"
...
OPTRACE "main_d_axi_i2s_audio_0_0_synth_1" END { }
